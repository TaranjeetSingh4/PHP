...
<div class="col-md-7 custom-class">
<div class="loginwrap">
    ...
    <div id="login">
        ...
        <form action="./controller/login.php" id="login-form" method="post">
            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <select name="role" class="form-control">
                            ...
                            ?>
                            <option value="<?php echo $row['id'] ?>" <?php echo $status; ?> ><?php echo $row['role']; ?></option>
                            <?php    
                            }
                            ?>
                        </select>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <select name="role" class="form-control">
                            <option value="null" id="choose-role" style="color:grey">------ Choose Role ---------</option>
                            <option value="SHASAN" >CHC</option>  
                            <option value="SHASAN" >PHC</option>  
                            <option value="SHASAN" >DH</option>   
                        </select>
                        <span class="focus-border"><i></i></span>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <select name="role" class="form-control">
                            <option value="null" id="choose-role" style="color:grey">------ Choose Role ---------</option>
                            <option value="SHASAN" >NHM Contractual</option>  
                            <option value="SHASAN" >Permanent</option>   
                        </select>
                        <span class="focus-border"><i></i></span>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <input type="submit" class="btn btn-block btn-success" id="register-submit" value="Register">
