...
if ($blood_center_id) {
    $sql = "
        SELECT 
            ...
            t.status AS treatment_status, t.room_no, t.block, t.doctor_name, t.file_path,d.name AS district_name,tc.center_name
        FROM users u
        ...
        WHERE (u.blood_center_id = ? AND u.referred_blood_center IS NULL) 
           OR u.referred_blood_center = ?
        GROUP BY u.id
    ";
